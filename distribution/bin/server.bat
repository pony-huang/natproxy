...
%JAVACMD% %JAVA_OPTS% -Xms128M -Xmx128M -Xss256k -classpath %CLASSPATH% -Dapp.name="server" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.github.ponking66.ServerApplication %CMD_LINE_ARGS%
